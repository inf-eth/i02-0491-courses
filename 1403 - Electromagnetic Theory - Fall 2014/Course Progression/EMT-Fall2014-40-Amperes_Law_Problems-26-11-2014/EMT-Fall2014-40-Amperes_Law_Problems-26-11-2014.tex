...
%opening
\title{Electromagnetic Theory\\Class 40\\Ampere's Law\\Problems}
\author{Attique Dawood}
\date{November 26, 2014\\[0.2cm] Last Modified: \today, \currenttime}
\begin{document}
\maketitle
\section{Revision}
\begin{itemize}
\item Biot--Savart Law.
\item Magnetic field of a straight current carrying wire.
\end{itemize}
