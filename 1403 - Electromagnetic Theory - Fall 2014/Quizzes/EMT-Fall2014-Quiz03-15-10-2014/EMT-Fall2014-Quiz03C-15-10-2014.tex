...
%opening
\title{\vspace{-1.5cm}Electromagnetic Theory - Fall 2014\\Quiz \#03C}
...
\noindent \textbf{Question:} Find the flux of \textbf{A}$=xy\hat x+z^2\hat y+2xyz\hat z$ over the surface of unit cube $0<x,y,z<1$.
...
$\nabla\cdot\mathrm{\textbf A}=y+2xy$\\
$\int\limits_v(\nabla\cdot\mathrm{\textbf A})dv=\int\limits_0^1\int\limits_0^1\int\limits_0^1(y+2xy)dxdydz=\dfrac{1}{2}+\dfrac{1}{2}=1$
\end{document}
