...
\begin{itemize}
\item Assignment 01 is due on Thursday, 20th June.
\item Make a complex class that can add, subtract, multiply and divide complex numbers.
\item Make a matrix class that can add/subtract matrices.
\item Create a matrix class of complex numbers.
\item Earn full credit for this assignment implementing matrix multiplication.
\item Quiz 01 on Thursday.
\end{itemize}
\section{Revision}
\begin{itemize}
