...
%opening
\title{\vspace{-2cm}Programming for Engineers II\\Class 40\\File Handling\\Modes and Flags\\Reading/Writing Objects}
\author{Attique Dawood}
\date{July 29, 2013\\[0.2cm] Last Modified: \today, \currenttime}
\begin{document}
\maketitle
\section{File Modes}
