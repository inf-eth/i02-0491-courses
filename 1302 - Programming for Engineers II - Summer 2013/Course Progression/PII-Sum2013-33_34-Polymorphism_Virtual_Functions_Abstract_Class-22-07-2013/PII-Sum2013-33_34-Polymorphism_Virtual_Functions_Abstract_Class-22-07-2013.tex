...
%opening
\title{\vspace{-2cm}Programming for Engineers II\\Class 33, 34\\Polymorphism\\Virtual Functions\\Abstract Class}
\author{Attique Dawood}
\date{July 22, 2013\\[0.2cm] Last Modified: \today, \currenttime}
\begin{document}
\maketitle
