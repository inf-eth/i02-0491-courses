...
%opening
\title{\vspace{-2cm}Programming for Engineers II\\Class 17\\Array Subscript Operator}
\author{Attique Dawood}
\date{March 03, 2014\\[0.2cm] Last Modified: \today, \currenttime}
\begin{document}
\maketitle
...
\section{Revision}
\begin{itemize}
\item \verb|friend| functions and classes.
\item Stream operators \verb|<<| and \verb|>>|.
\end{itemize}
