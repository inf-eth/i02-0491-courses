...
\usepackage{textcomp}
% General options.
\lstset{breaklines=true, basicstyle=\scriptsize\ttfamily, tabsize=4, numbers=none, stepnumber=1, frame=none, showstringspaces=false, upquote=true}
