...
%opening
\title{\vspace{-2.5cm}Physics for Engineers - Fall 2013\\Quiz \#03AD}
...
\noindent \textbf{Question:} Given a vector field $\textbf{A}=y^2\hat x+2xy\hat y$ find the circulation of \textbf{A} ($\oint\limits_{L} \textbf{A}\cdot d\textbf{\textit{l}}$) over closed path CDAC.
\begin{figure}[H]
\flushright
