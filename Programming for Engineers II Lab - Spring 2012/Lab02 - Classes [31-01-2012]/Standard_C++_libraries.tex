...
The standard header for \emph{string.h} in C++ is \emph{cstring}. Anther header \emph{string} is available in C++ and contains the implementation of \texttt{string} class. This is completely different from the \emph{string.h} and \emph{cstring} libraries.
