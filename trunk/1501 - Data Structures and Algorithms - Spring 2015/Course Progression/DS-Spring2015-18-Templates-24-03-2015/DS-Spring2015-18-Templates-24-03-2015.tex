...
%opening
\title{Data Structures and Algorithms\\Class 18\\Templates\\Deep and Shallow Copy}
...
\begin{itemize}
\item Assignment 02 to be submitted on Thursday.
\end{itemize}
\section{Revision}
\begin{itemize}
...
\end{lstlisting}
\section{Shallow and Deep Copy~\cite[pg. 153]{Malik}}
\section{The \texttt{copy} Algorithm~\cite[pg. 223--227]{Malik}}
%\section{Exercises}
