...
%opening
\title{\vspace{-2.5cm}Physics for Engineers - Fall 2013\\Quiz \#03B}
...
\noindent \textbf{Question:} Given a vector field $\textbf{A}=y^2\hat x+2xy\hat y$ find the circulation of \textbf{A} ($\oint\limits_{L} \textbf{A}\cdot d\textbf{\textit{l}}$) over closed path BCAB.
\begin{figure}[H]
\flushright
\begin{tikzpicture}[xscale=1.2,yscale=1.2,font=\small]
	...
	\draw[thick, ->, >=stealth] (2cm, 4cm) -- (1.5cm, 3cm);
	\draw[thick] (1.5cm, 3cm) -- (1cm, 2cm);
