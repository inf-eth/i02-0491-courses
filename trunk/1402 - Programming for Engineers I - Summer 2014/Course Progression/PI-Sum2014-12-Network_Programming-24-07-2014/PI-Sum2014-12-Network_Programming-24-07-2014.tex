...
char Message[512] = char Message[30] = "Hello world!";
int BytesSent;
BytesSent = Obj.Send((void*)Message, sizeof(Message)+1); // sizeof(Message) is equivalent to strlen(Message). BytesSent should be equal to sizeof(Message)+1.

char Buffer[512];
int ByteseReceived;
BytesReceived = Obj.Receive((void*)Buffer, 512); // 30 is max buffer size. Received bytes will be equal to sent bytes.
\end{lstlisting}
\section{Exercise}
